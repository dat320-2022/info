...
1. Initially, you will get access to two repositories when you have signed up on QuickFeed.
   ...
   The first is the [`assignments`](https://github.com/dat320-2022/assignments) repository, which is where we publish all lab assignments, skeleton code and additional information.
...
3. Once ssh is configured, you need to decide on a suitable location for your workspace for the course.
   In this guide we will use `$HOME/dat320-2022` as the workspace.
   Do the following making sure to replace `username` with your GitHub user name:

   ```console
   mkdir $HOME/dat320-2022
   cd $HOME/dat320-2022
...
7. In summary, these are the typical steps that are necessary to make changes to
   ...
   ```console
   cd $HOME/dat320-2022/assignments/lab1
...
1. As time goes by the teaching staff may publish updates to the
   course [assignments](https://github.com/dat320-2022/assignments) repo,
...
We assume you have already created the `dat320-2022` directory on your machine.

```console
cd $HOME/dat320-2022
git clone git@github.com:dat320-2022/groupname.git
cd groupname
git remote add course-assignments git@github.com:dat320-2022/assignments
git pull course-assignments main
```
