...
The syllabus include the chapters in the lecture plan (chapters 2-40)

## Syllabus also include

- published slides and code snippets available on [info](https://github.com/dat320-2022/info/)
